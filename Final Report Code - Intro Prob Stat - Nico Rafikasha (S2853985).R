...
covariates <- read_excel("Data/Data/covariates.xlsx")
head(covariates)
hist(covariates$`Vas-12months`)

biomarkers <- read_excel("Data/Data/biomarkers.xlsx")
head(biomarkers)
...
# 3. SIMPLE LINEAR REGRESSION CONSTRUCTION
# -------------------------------
...
# In this train and test split, it randomly select the observations 
# As long as train is 80% of total data, so dont be surprised when the R-squared is differ when executing the code again
